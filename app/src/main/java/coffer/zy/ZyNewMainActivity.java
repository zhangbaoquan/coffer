 ...
 * @RevisionDescription：
 */
public class ZyNewMainActivity extends AppCompatActivity {
    ...
    protected IreaderPlugApi.OnLaunchPluginCallback mOnLaunchPluginCallBack = new IreaderPlugApi.OnLaunchPluginCallback() {
        ...
        public void onPluginNotInstall() {
            Toast.makeText(ZyNewMainActivity.this, "插件未安装",Toast.LENGTH_SHORT).show();
        }

        @Override
        public void onError(int code, String msg) {
            Toast.makeText(ZyNewMainActivity.this, msg,Toast.LENGTH_SHORT).show();
        }
    };
